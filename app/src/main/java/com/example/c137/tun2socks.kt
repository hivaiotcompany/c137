...
//    }
    ...
    private fun setup() {
        Log.d("com.example.v2ray", "-----------------------SETUP-------------------------")
        val prepare = prepare(this)
        if (prepare != null) {
            Log.d("com.example.v2ray", "!prepare")
            Log.d("com.example.v2ray", prepare.toString())
            return
        }
...
//        }
    ...
    private fun runTun2socks() {
        Log.d("com.example.v2ray", "--------------------RUN-TUN2SUCKS-------------------------")
        val socksPort = 1080
...
//        }
        Log.d("com.example.v2ray", cmd.toString())
...
//        saveVpnNetworkInfo(configName, info)
    ...
    override fun attachBaseContext(newBase: Context?) {
        val context = newBase?.let {
            MyContextWrapper.wrap(newBase,  Locale("en"))
        }
